...
h4 {
    margin: 10px 0 20px 0; /* 调整标题的上下间距 */
    font-size: 1.5em;
    color: #07539b;
}
.unit {
...
.cpu_memory_row {
    display: flex; /* 设置为横向排布 */
    justify-content: space-around; /* 均匀分布 */
    align-items: center; /* 垂直方向居中 */
    justify-content: center; /* 子元素居中 */
    gap: 70px; /* 子元素之间的间距 */
    padding-left: 150px; /* 添加右移偏移量 */
}

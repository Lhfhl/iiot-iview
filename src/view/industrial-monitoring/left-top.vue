...
import Echart from '@/components/screenechart/index.vue'
  ...
  methods: {
    ...
    getData() {
      ...
      currentGET('big1').then(res => {
        ...
        if (res.success) {
          this.countDeviceNumData = res.data
          this.$nextTick(() => {
            this.init()
          })
        } else {
    ...
    init() {
      let total = this.countDeviceNumData.totalNum;
      ...
      let piedata = {
        ...
        data: [
          ...
          // },
          {
            value: this.countDeviceNumData.lockNum,
            name: "锁定",
            label: {
              shadowColor: colors[0],
            },
          ...
          {
            value: this.countDeviceNumData.onlineNum,
            name: "在线",
            label: {
          ...
          {
            value: this.countDeviceNumData.offlineNum,
            name: "离线",
            label: {
